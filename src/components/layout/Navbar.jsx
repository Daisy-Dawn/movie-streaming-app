...
const Navbar = () => {
    ...
    return (
        <nav className="app__navbar flex font-roboto sticky top-0 w-full z-[20]  items-center h-[100px]">
            ...
            <div className=" flex w-[30%] justify-end items-center gap-[1.5rem]">
